...
Date: 6/26/2018
Purpose: Contains the ability to clockin and clockout for the volunteers. 
 */
package projectBark;
...
//Parts of this code was received from an outside source (https://gist.github.com/jewelsea/2658491)
    ...
    public static double totalCHours = 0;
    ...
    public void start() {
        ...
        timeData.clear();
        viewClockIn();
        mainVolunteerWindow.checkPane.setAlignment(Pos.CENTER);
        mainVolunteerWindow.checkPane.setMinWidth(600);
        mainVolunteerWindow.checkPane.setVgap(5.5);
        mainVolunteerWindow.checkPane.setHgap(5.5);
        mainVolunteerWindow.checkPane.setPadding(new Insets(10, 10, 30, 10));
        hbButton.setSpacing(4);
        hbButton.getChildren().addAll(btnchkin, btnchkout);
        mainVolunteerWindow.checkPane.add(clockTable, 5, 5);
        mainVolunteerWindow.checkPane.add(hbButton, 5, 2);
        mainVolunteerWindow.checkPane.add(lblTotal, 5, 6);
        mainVolunteerWindow.checkPane.add(lblHrs, 5, 7);
        ...
        mainVolunteerWindow.checkPane.add(layout, 5, 0);
    ...
    // get total hours for volunteering
    public double hours() {
    ...
    // update total hours for volunteering
    public void updateVolunteerHours() {
        String sqlQuery = "";
        sqlQuery = "update volunteer set vtotalhours =" + hours() + "where vusername = '" + loginPage.txtuserName.getText() + "'";
        sendDBCommand(sqlQuery);
    }
